<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="Latitud" min-width="100px" align="center">
        <template slot-scope="{ row }">
          <span>{{ row.latitude }}</span>
        </template>
      </el-table-column>
      <el-table-column label="Longitud" min-width="100px" align="center">
        <template slot-scope="{ row }">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        <el-form-item label="Nombre">
          <el-input v-model="formStadium.name"></el-input>
        </el-form-item>
        <el-form-item label="Latitud">
          <el-input v-model="formStadium.latitude"></el-input>
        </el-form-item>
        <el-form-item label="Longitud">
          <el-input v-model="formStadium.longitude"></el-input>
        </el-form-item>
